...
config.appName = 'Obsidian';
config.appDescription = 'ICONation MultiSig Wallet';
config.appSlogan = 'Obsidian';
config.appId = 'org.iconation.obsidian';
config.appGitRepo = 'https://github.com/ICONation/obsidian';
