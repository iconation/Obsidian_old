...
var ObsidianAddressBook = function (path, name, pass) {
    if (!(this instanceof ObsidianAddressBook)) return new ObsidianAddressBook(pass, name, path);
    this.path = path;
...
ObsidianAddressBook.prototype.setParams = function (path, pass) {
    if (path) this.path = path;
    if (pass) this.pass = pass;
    return true;
};

ObsidianAddressBook.prototype.create = function (ignoreExists) {
...
ObsidianAddressBook.prototype.initFile = function () {
    return new Promise((resolve, reject) => {
        try {
...
ObsidianAddressBook.prototype.load = function () {
    return new Promise((resolve, reject) => {
...
ObsidianAddressBook.prototype.save = function (addressBookData) {
    return new Promise((resolve, reject) => {
        let gcm = new GCM(this.pass, this.cipherConfig);
...
module.exports = ObsidianAddressBook;